...
function setData(html){
	...
	document.querySelector(".header iframe").contentWindow.document.head.appendChild(viewCss);
	let headerElem = document.createElement("header");
	headerElem.innerHTML = html.header;
	document.querySelector(".header iframe").contentWindow.document.body.appendChild(headerElem);
	document.querySelector(".footer textarea").value = html.footer;
	document.querySelector(".header iframe").contentWindow.document.head.appendChild(viewCss);
	let footerElem = document.createElement("footer");
	footerElem.innerHTML = html.footerer;
	document.querySelector(".footer iframe").contentWindow.document.body.appendChild(footerElem);
